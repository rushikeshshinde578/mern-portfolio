...
const ManageSkills = () => {
  ...
  return (
    <>
      <div className="flex min-h-screeen w-full flex-col bg-muted/40">
        <Tabs>
          <TabsContent>
            <Card>
                    ...
                    return(
                      <Card key={element._id}>
                        ...
                        <CardFooter>
                          ...
                          <Input type="number" defaultValue={element.proficiency} onChange={(e) => handleInputChange(e.target.value)} onBlur={()=> handleUpdateSkill(element._id)}/>
                        </CardFooter>
                      </Card>
                    )
