            ...
            <div>
                <div className="grid w-[100%] gap-6">
                    <div className="grid gap-2">
                        <h1 className="text-3x1 font-bold">Update Profile</h1>
                ...
                <div className="grid gap-6">
                    <div className="flex items-start lg:justify-between lg:items-center flex-col lg:flex-row gap-5">
                        <div className="grid gap-2 w-full sm:w-72">
                            ...
                            <img src={avatarPreview ? avatarPreview : "./avatarHolder.jpg"} alt="avatar" className="w-full h-auto sm:w-72 sm:h-72 rounded-2x1"/>
                        ...
                        <div className="grid gap-2 w-full sm:w-72">
                            ...
                            <Link to={user && user.resume && user.resume.url} target="_blank">
                                <img src={resumePreview ? resumePreview : "./avatarHolder.jpg"} alt="resume" className="w-full h-auto sm:w-72 sm:h-72 rounded-2x1"/>
                            </Link>
                            <div className="relative">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Textarea placeholder="About Me" value={aboutMe} onChange={(e)=> setAboutMe(e.target.value)}d />
                    </div>
                    <div className="grid gap-2">
