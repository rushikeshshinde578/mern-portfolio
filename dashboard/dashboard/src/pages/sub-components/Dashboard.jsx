      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
        <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-2 xl:grid-cols-2">
          <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
              ...
              <Card className="flex flex-col justify-center">
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-6x1">{projects && projects.length}</CardTitle>
                </CardHeader>
                <CardFooter>
              ...
              <Card className="flex flex-col justify-center">
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-6x1">{skills && skills.length}</CardTitle>
                </CardHeader>
                <CardFooter>
                      ...
                      <TableBody>
                        {
                          projects && projects.length > 0 ? (
                            ...
                            <TableCell className="text-3x1 overflow-y-hidden">
                  ...
                  <CardContent className="grid sm:grid-cols-2 gap-4">
                    {
                      ...
                      ) : <p className="text-3x1 overflow-y-hidden">
                      You have not added any project.
                    </p>
                    }
                  </CardContent>
            ...
            <Tabs>
              <TabsContent className="grip min-[1050px]:grid-cols-2 gap-4">
                <Card>
                  <CardHeader className="px-7">
