        ...
        <form className="w-[100%] px-5 md:w-[1000px]" onSubmit={handleAddNewProject}>
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className="font-semibold leading-7 text-gray-900 text-3x1 text-center">ADD NEW PROJECT</h2>
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div className="text-center">
                      {
                        projectBannerPreview ? (<img className="mx-auto h-[250px] w-full text-gray-300" viewBox="0 0 24 24" src={projectBannerPreview ? `${projectBannerPreview}` : 
            ...
            {
              loading ? <SpecialLoadingButton content={"Adding"} width={"w-56"}/> : <Button type="submit" className="w-56">Add Project</Button>
            }
          </div>
        </form>
      </div>
