// in slice we can put reducers and actions on same Place.
...
//for logedin user even if he refresh the page
...
export const updatePassword = (currentPassword, newPassword, confirmPassword) => async(dispatch) => {
    ...
    try {
        const {data} = await axios.put("http://localhost:4000/api/v1/user/update/password",{currentPassword, newPassword, confirmPassword},
            {
